...
const giftMessages = {
  ...
  secret: ['secret found', 'I met you, and I knew I had to tell you: I love you, bby, lots. ♥']
};
...
function speakBirthday() { if (!('speechSynthesis' in window)) return; speechSynthesis.cancel(); for (let repeat = 0; repeat < 3; repeat += 1) { const voice = new SpeechSynthesisUtterance('Happy birthday, dear sweetheart. May you live a happy life, always. I love you, bby, lots.'); voice.volume = 1; voice.rate = .85; voice.pitch = 1.12; voice.lang = 'en-US'; window.setTimeout(() => speechSynthesis.speak(voice), repeat * 5000); } }
